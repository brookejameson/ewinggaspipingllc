...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        axios({
            method: 'post',
            url: 'https://formsubmit.co/f1a3c7217dbdc96155fff3d1f64351b1', // need to update email
            data: fData,
            headers: {
                ...
                <div className="container mx-auto my-8 px-4 lg:px-20" data-aos="zoom-in">
                    ...
                    <div className="w-full lg:-mt-96 lg:w-2/6 px-8 py-6 ml-auto bg-red rounded-2xl">
                        <div className="flex flex-col text-white">
                            ...
                            <div className="flex my-4 w-2/3 lg:w-1/2">
                                <a href="https://www.facebook.com/ENLIGHTENEERING/" target="_blank" rel="noreferrer" className="rounded-full flex justify-center bg-white h-8 text-red w-8 mx-1 text-center pt-1">
